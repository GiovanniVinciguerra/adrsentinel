 ...
 * della denominazione (Name) di un Numero ONU.
 * <p>
 ...
 * di denominazione (es. payload JSON mancanti).</li>
...
@NotNull(message = "Onu number name cannot be null")
@Size(
	max = 255,
	message = "Onu number name must not exceed 255 characters."
)
public @interface ValidatorOnuNumberName {
	 ...
	 */
	String message() default "ONU number name is required and must not exceed 255 characters.";
	/**
