 ...
 * del gruppo d'imballaggio (PackingGroup) di un Numero ONU.
 * <p>
 ...
 * di gruppo d'imballaggio (es. payload JSON mancanti).</li>
...
@Size(
	max = 255,
	message = "Packing group must not exceed 255 characters."
)
public @interface ValidatorPackingGroup {
	 ...
	 */
	String message() default "Packing group is required and must not exceed 255 characters.";
	/**
