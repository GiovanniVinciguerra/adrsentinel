 ...
 * dello stato fisico (PhysicalState) di un Numero ONU.
 * <p>
 ...
 * di stato fisico (es. payload JSON mancanti).</li>
...
@Size(
	max = 255,
	message = "Physical state must not exceed 255 characters."
)
public @interface ValidatorPhysicalState {
	 ...
	 */
	String message() default "Physical state is required and must not exceed 255 characters.";
	/**
