 ...
 * dell'attraversamento di specifici tunnel (TunnelRestriction) di un Numero ONU.
 * <p>
 ...
 * di restrizioni di eventuali tunnel (es. payload JSON mancanti).</li>
 * <li><b>Limite Fisico ({@code @Size}):</b> Impone un tetto massimo di 255 caratteri, allineando 
 * in modo sicuro la validazione applicativa (Edge Validation) con la reale capienza 
 * della colonna {@code VARCHAR(255)} sul database relazionale.</li>
 * </ol>
 * </p>
 * <p>
...
@Size(
	max = 255,
	message = "Tunnel restriction must not exceed 255 characters."
)
public @interface ValidatorTunnelRestriction {
	 ...
	 */
	String message() default "Tunnel restriction is required and must not exceed 255 characters.";
	/**
